...
for _routine in $ROUTINEs; do
    ...
    do
        ...
        echo "In Figure~\ref{${_routine}1.${abbriv}}, we show the result of {\tt ${_routine}} performance for {\tt binary128}, {\tt binary80} and {\tt double-double}, and in Figure~\ref{${_routine}2.${abbriv}} we show the result of {\tt ${_routine}} performance for {\tt MPFR}, {\tt GMP} and {\tt quad-double} on ${corename}."
        IFS=" "
        PEAKS=""
        for _mp1 in $MP1s; do
        ...
        echo "The peak performances of the reference {\tt ${_routine}}s of {\tt binary128}, {\tt binary80} and {\tt double-double} are$PEAKS respectively."
        ...
        echo "The peak performances of simple OpenMP parallelized {\tt ${_routine}}s of {\tt binary128}, {\tt binary80} and {\tt double-double} are$PEAKS respectively."
        ...
        echo "\begin{figure}"
        echo "\caption{ {\tt ${_routine}} performance on ${corename} for {\tt binary128}, {\tt binary80} and {\tt double-double} with/without simple OpenMP acceleration. }" 
