...
plot \
"log.Rsyrk._Float128"       using 1:3 title '\_Float128'             with lines linewidth 1, \
"log.Rsyrk._Float128_opt"   using 1:3 title '\_Float128 (OpenMP)'    with lines linewidth 1, \
