...
env $LDPATHPREFIX timeout $TIMEOUT ./dgemm_ref      -STEP 7 -TOTALSTEPS 714 -LOOPS 3 >& log.dgemm.ref
...
env $LDPATHPREFIX timeout $TIMEOUT ./Rgemm.${_mplib}     -NOCHECK    >& log.Rgemm.${_mplib}
done
####
