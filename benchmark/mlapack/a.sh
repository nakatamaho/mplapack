...
sed -ibak 's/mpfr/dd/g' "$NAME"_dd.cpp
sed -ibak 's/___MPACK_BUILD_WITH_MPFR___/___MPACK_BUILD_WITH_DD___/g' "$NAME"_dd.cpp

sed -ibak 's/MPFR/GMP/g' "$NAME"_gmp.cpp
sed -ibak 's/mpfr/gmp/g' "$NAME"_gmp.cpp
sed -ibak 's/mpreal/mpf_class/g' "$NAME"_gmp.cpp
sed -ibak 's/___MPACK_BUILD_WITH_MPFR___/___MPACK_BUILD_WITH_GMP___/g' "$NAME"_gmp.cpp

sed -ibak 's/mpreal/qd_real/g' "$NAME"_qd.cpp
sed -ibak 's/MPFR/QD/g' "$NAME"_qd.cpp
sed -ibak 's/mpfr/qd/g' "$NAME"_qd.cpp
sed -ibak 's/___MPACK_BUILD_WITH_MPFR___/___MPACK_BUILD_WITH_QD___/g' "$NAME"_qd.cpp

sed -ibak 's/mpreal/__float128/g' "$NAME"___float128.cpp
sed -ibak 's/MPFR/__FLOAT128/g' "$NAME"___float128.cpp
sed -ibak 's/mpfr/__float128/g' "$NAME"___float128.cpp
sed -ibak 's/___MPACK_BUILD_WITH_MPFR___/___MPACK_BUILD_WITH___FLOAT128___/g' "$NAME"___float128.cpp

sed -ibak 's/mpreal/double/g' "$NAME"_double.cpp
sed -ibak 's/MPFR/DOUBLE/g' "$NAME"_double.cpp
sed -ibak 's/mpfr/double/g' "$NAME"_double.cpp
sed -ibak 's/___MPACK_BUILD_WITH_MPFR___/___MPACK_BUILD_WITH_DOUBLE___/g' "$NAME"_double.cpp
