...
struct variant_member {
    ...
    template <typename DimsType> variant_member(size_t type_size_, DimsType const &dims_) : type_size(type_size_), dims(dims_) {}
...
template <typename T> struct mbr : variant_member {
    ...
    template <typename DimsType> mbr(DimsType const &dims_) : variant_member(sizeof(T), dims_) {}
};
template <int StrLen> struct mbr<str<StrLen>> : variant_member {
    mbr() : variant_member(StrLen) {}
    template <typename DimsType> mbr(DimsType const &dims_) : variant_member(StrLen, dims_) {}
};
struct equivalence {
    ...
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2) : members_size(2), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
    }
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2, variant_member const &mbr_3) : members_size(3), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
        members[2] = mbr_3;
    }
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2, variant_member const &mbr_3, variant_member const &mbr_4) : members_size(4), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
        members[2] = mbr_3;
        members[3] = mbr_4;
    }
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2, variant_member const &mbr_3, variant_member const &mbr_4, variant_member const &mbr_5) : members_size(5), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
        members[2] = mbr_3;
        members[3] = mbr_4;
    ...
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2, variant_member const &mbr_3, variant_member const &mbr_4, variant_member const &mbr_5, variant_member const &mbr_6) : members_size(6), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
        members[2] = mbr_3;
        members[3] = mbr_4;
    ...
    equivalence(variant_member const &mbr_1, variant_member const &mbr_2, variant_member const &mbr_3, variant_member const &mbr_4, variant_member const &mbr_5, variant_member const &mbr_6, variant_member const &mbr_7) : members_size(7), array_alignment(members_size), align_i_mbr(size_t_max), align_byte_offset(size_t_max) {
        members[0] = mbr_1;
        members[1] = mbr_2;
        members[2] = mbr_3;
        members[3] = mbr_4;
    ...
    template <size_t Jmbr> equivalence &align(size_t index_1d = 0, size_t str_offset = 0) {
        align_i_mbr = Jmbr - 1;
        align_byte_offset = members[align_i_mbr].type_size * index_1d + str_offset;
        return *this;
    }
    template <size_t Jmbr> equivalence &align(arr_index const &arr_ix) {
        align<Jmbr>(members[Jmbr - 1].actual_index_1d(arr_ix));
        return *this;
    }
    template <size_t Jmbr> equivalence &align(arr_and_str_indices<arr_dim_max> const &indices) {
        align<Jmbr>(members[Jmbr - 1].actual_index_1d(indices.arr_ix), static_cast<size_t>(indices.str_ix.first - 1));
        return *this;
    }
    template <size_t Jmbr> equivalence &align(str_index const &ix) {
        align<Jmbr>(0, static_cast<size_t>(ix.first - 1));
        return *this;
    }
    template <size_t Jmbr> equivalence &with(size_t index_1d = 0, size_t str_offset = 0) {
        array_alignment.add_anchor(align_i_mbr, align_byte_offset, Jmbr - 1, members[Jmbr - 1].type_size * index_1d + str_offset);
        return *this;
    }
    template <size_t Jmbr> equivalence &with(arr_index const &arr_ix) {
        with<Jmbr>(members[Jmbr - 1].actual_index_1d(arr_ix));
        return *this;
    }
    template <size_t Jmbr> equivalence &with(arr_and_str_indices<arr_dim_max> const &indices) {
        with<Jmbr>(members[Jmbr - 1].actual_index_1d(indices.arr_ix), static_cast<size_t>(indices.str_ix.first - 1));
        return *this;
    }
    template <size_t Jmbr> equivalence &with(str_index const &ix) {
...
struct variant_allocate_chain {
    ...
    size_t curr_bytes;
    size_t end_bytes;
    variant_allocate_chain(variant_core *core_, variant_bindings *bindings_, bool is_common_variant_) : core(core_), bindings(bindings_), is_common_variant(is_common_variant_), curr_bytes(0), end_bytes(0) {}
...
struct variant_bind_chain {
    ...
    bool is_common_variant;
    size_t bind_index;
    variant_bind_chain(variant_core *core_, variant_bindings *bindings_, bool is_common_variant_) : core(core_), bindings(bindings_), is_common_variant(is_common_variant_), bind_index(0) { core->use_count++; }
...
struct common_variant : variant_bind_chain {
    common_variant(variant_core &core, variant_bindings &bindings) : variant_bind_chain(&core, &bindings, /*is_common_variant*/ true) {}
};
