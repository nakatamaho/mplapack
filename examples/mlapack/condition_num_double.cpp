...
void getAinv(mpackint n, mpackint lda, double *A)
{
    mpackint info;
    mpackint lwork;
...
double get_estimated_condition_num(const char *norm, mpackint n, mpackint lda, double *A)
{
    double anorm, cond, rcond;
    double *work = new double[std::max((mpackint) 1, n * 4)];
...
double get_exact_condition_num(const char *norm, mpackint n, mpackint lda, double *A)
{
    double *Ainv = new double[n * n];
    double *work = new double[std::max((mpackint) 1, n)];
