...
void getAinv(mpackint n, mpackint lda, qd_real * A)
{
    mpackint info;
    mpackint lwork;
...
qd_real get_estimated_condition_num(const char *norm, mpackint n, mpackint lda, qd_real * A)
{
    qd_real anorm, cond, rcond;
    qd_real *work = new qd_real[std::max((mpackint) 1, n * 4)];
...
qd_real get_exact_condition_num(const char *norm, mpackint n, mpackint lda, qd_real * A)
{
    qd_real *Ainv = new qd_real[n * n];
    qd_real *work = new qd_real[std::max((mpackint) 1, n)];
