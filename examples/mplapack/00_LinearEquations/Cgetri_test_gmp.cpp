...
//setting a matrix
    ...
    a[0 + 0 * n] = mpfc_class(1.0, 0.0);   a[0 + 1 * n] = mpfc_class(1.0, 2.0);    a[0 + 2 * n] = mpfc_class(2.0, 10.0);
    a[1 + 0 * n] = mpfc_class(1.0, 1.0);   a[1 + 1 * n] = mpfc_class(0.0, 3.0);    a[1 + 2 * n] = mpfc_class(-5.0, 14.0);
    a[2 + 0 * n] = mpfc_class(1.0, 1.0);   a[2 + 1 * n] = mpfc_class(0.0, 5.0);    a[2 + 2 * n] = mpfc_class(-8.0, 20.0);
...
//work space query
    ...
    delete[]work;
    work = new mpfc_class[std::max(1, (int) lwork)];
