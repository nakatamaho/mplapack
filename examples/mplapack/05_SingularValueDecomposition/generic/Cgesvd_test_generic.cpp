int main() {
    ...
    // setting A matrix
    a[0 + 0 * n] = COMPLEX(0.25, 0.0); a[0 + 1 * n] = COMPLEX(0.0, -2.25); a[0 + 2 * n] = COMPLEX(-1.75,0.0);   a[0 + 3 * n] = COMPLEX(0.0, 0.25);
    a[1 + 0 * n] = COMPLEX(0.0,-2.25); a[1 + 1 * n] = COMPLEX(-0.25, 0.0); a[1 + 2 * n] = COMPLEX(0.0, -0.25);  a[1 + 3 * n] = COMPLEX(-1.75, 0.0);
    a[2 + 0 * n] = COMPLEX(-1.75,0.0); a[2 + 1 * n] = COMPLEX(0.0, -0.25); a[2 + 2 * n] = COMPLEX(0.25, 0.0);   a[2 + 3 * n] = COMPLEX(0.0, 2.25);
    a[3 + 0 * n] = COMPLEX(0.0, 0.25); a[3 + 1 * n] = COMPLEX(-1.75, 0.0); a[3 + 2 * n] = COMPLEX(0.0, 2.25);   a[3 + 3 * n] = COMPLEX(-0.25, 0.0);
