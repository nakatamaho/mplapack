...
int main() {
    ...
    mplapack_binary128_t *a = new mplapack_binary128_t[n * n]; mplapack_binary128_t *aorg = new mplapack_binary128_t[n * n]; mplapack_binary128_t *b = new mplapack_binary128_t[n*nrhs]; mplapack_binary128_t *borg = new mplapack_binary128_t[n*nrhs]; mplapack_binary128_t *xexact = new mplapack_binary128_t[n*nrhs];
