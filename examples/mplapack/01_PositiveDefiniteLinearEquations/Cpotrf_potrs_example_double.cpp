...
int main() {
    ...
    std::complex<double> *b = new std::complex<double>[n * nrhs];
    std::complex<double> *borg = new std::complex<double>[n * nrhs];
    std::complex<double> *xexact = new std::complex<double>[n * nrhs];
    a[0] = std::complex<double>(5.0, 0.0);
    a[1] = std::complex<double>(1.0, -1.0);
    a[2] = std::complex<double>(1.0, 1.0);
    a[3] = std::complex<double>(4.0, 0.0);
    xexact[0] = std::complex<double>(1.0, 1.0);
    xexact[1] = std::complex<double>(2.0, -1.0);
    xexact[0 + n] = std::complex<double>(-1.0, 0.0);
    xexact[1 + n] = std::complex<double>(0.0, 2.0);
