...
int main() {
    ...
    mplapack_binary80_t *b = new mplapack_binary80_t[n*nrhs];
    mplapack_binary80_t *borg = new mplapack_binary80_t[n*nrhs];
    mplapack_binary80_t *xexact = new mplapack_binary80_t[n*nrhs];
