...
int main() {
    ...
    mplapack_binary80_t *a = new mplapack_binary80_t[n * n]; mplapack_binary80_t *aorg = new mplapack_binary80_t[n * n]; mplapack_binary80_t *b = new mplapack_binary80_t[n]; mplapack_binary80_t *borg = new mplapack_binary80_t[n]; mplapack_binary80_t *xexact = new mplapack_binary80_t[n];
