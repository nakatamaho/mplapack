...
int main() {
    ...
    dd_complex *a = new dd_complex[n*n]; dd_complex *aorg = new dd_complex[n*n]; dd_complex *b = new dd_complex[n]; dd_complex *borg = new dd_complex[n]; dd_complex *xexact = new dd_complex[n];
    ...
    for(mplapackint i=0;i<n;i++){ b[i]=dd_complex(0.0,0.0); for(mplapackint k=0;k<n;k++) b[i]=b[i]+aorg[i+k*lda]*xexact[k]; borg[i]=b[i]; }
