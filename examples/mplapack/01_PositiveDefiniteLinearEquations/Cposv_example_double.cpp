...
int main() {
    ...
    std::complex<double> *a = new std::complex<double>[n*n]; std::complex<double> *aorg = new std::complex<double>[n*n]; std::complex<double> *b = new std::complex<double>[n]; std::complex<double> *borg = new std::complex<double>[n]; std::complex<double> *xexact = new std::complex<double>[n];
    ...
    for(mplapackint i=0;i<n;i++){ b[i]=std::complex<double>(0.0,0.0); for(mplapackint k=0;k<n;k++) b[i]=b[i]+aorg[i+k*lda]*xexact[k]; borg[i]=b[i]; }
