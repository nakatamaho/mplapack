...
int main() {
    ...
    mpf_class *a = new mpf_class[n * n]; mpf_class *aorg = new mpf_class[n * n]; mpf_class *b = new mpf_class[n*nrhs]; mpf_class *borg = new mpf_class[n*nrhs]; mpf_class *xexact = new mpf_class[n*nrhs];
