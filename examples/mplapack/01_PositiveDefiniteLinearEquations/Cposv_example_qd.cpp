...
int main() {
    ...
    qd_complex *a = new qd_complex[n*n]; qd_complex *aorg = new qd_complex[n*n]; qd_complex *b = new qd_complex[n]; qd_complex *borg = new qd_complex[n]; qd_complex *xexact = new qd_complex[n];
    ...
    for(mplapackint i=0;i<n;i++){ b[i]=qd_complex(0.0,0.0); for(mplapackint k=0;k<n;k++) b[i]=b[i]+aorg[i+k*lda]*xexact[k]; borg[i]=b[i]; }
