...
int main() {
    ...
    std::complex<mplapack_binary80_t> *b = new std::complex<mplapack_binary80_t>[n * nrhs];
    std::complex<mplapack_binary80_t> *borg = new std::complex<mplapack_binary80_t>[n * nrhs];
    std::complex<mplapack_binary80_t> *xexact = new std::complex<mplapack_binary80_t>[n * nrhs];
    a[0] = std::complex<mplapack_binary80_t>(5.0, 0.0);
    a[1] = std::complex<mplapack_binary80_t>(1.0, -1.0);
    a[2] = std::complex<mplapack_binary80_t>(1.0, 1.0);
    a[3] = std::complex<mplapack_binary80_t>(4.0, 0.0);
    xexact[0] = std::complex<mplapack_binary80_t>(1.0, 1.0);
    xexact[1] = std::complex<mplapack_binary80_t>(2.0, -1.0);
    xexact[0 + n] = std::complex<mplapack_binary80_t>(-1.0, 0.0);
    xexact[1 + n] = std::complex<mplapack_binary80_t>(0.0, 2.0);
