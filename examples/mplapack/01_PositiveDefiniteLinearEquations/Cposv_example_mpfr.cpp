...
int main() {
    ...
    mpcomplex *a = new mpcomplex[n*n]; mpcomplex *aorg = new mpcomplex[n*n]; mpcomplex *b = new mpcomplex[n]; mpcomplex *borg = new mpcomplex[n]; mpcomplex *xexact = new mpcomplex[n];
    ...
    for(mplapackint i=0;i<n;i++){ b[i]=mpcomplex(0.0,0.0); for(mplapackint k=0;k<n;k++) b[i]=b[i]+aorg[i+k*lda]*xexact[k]; borg[i]=b[i]; }
