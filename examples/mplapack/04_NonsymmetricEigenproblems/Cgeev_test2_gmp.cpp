...
int main() {
    ...
    mpfc_class *vl = new mpfc_class[n * n];
    mpfc_class *vr = new mpfc_class[n * n];
    mplapackint lwork = 4 * n;
    mpfc_class *work = new mpfc_class[lwork];
    mpf_class *rwork = new mpf_class[lwork];
    mplapackint info;
    // setting A matrix
    a[0 + 0 * n] = mpfc_class(7.0, 0.0);   a[0 + 1 * n] = mpfc_class(3.0, 0.0);  a[0 + 2 * n] = mpfc_class(1.0, 2.0);   a[0 + 3 * n] = mpfc_class(-1.0, 2.0);
    a[1 + 0 * n] = mpfc_class(3.0, 0.0);   a[1 + 1 * n] = mpfc_class(7.0, 0.0);  a[1 + 2 * n] = mpfc_class(1.0, -2.0);  a[1 + 3 * n] = mpfc_class(-1.0, -2.0);
    a[2 + 0 * n] = mpfc_class(1.0, -2.0);  a[2 + 1 * n] = mpfc_class(1.0, 2.0);  a[2 + 2 * n] = mpfc_class(7.0, 0.0);   a[2 + 3 * n] = mpfc_class(-3.0, 0.0);
    a[3 + 0 * n] = mpfc_class(-1.0, -2.0); a[3 + 1 * n] = mpfc_class(-1.0, 2.0); a[3 + 2 * n] = mpfc_class(-3.0, 0.0);  a[3 + 3 * n] = mpfc_class(7.0, 0.0);
