...
int main() {
    ...
    a[3 + 0 * n] = std::complex<_Float128>(1.0, 1.0); a[3 + 1 * n] = std::complex<_Float128>(2.0, 2.0);   a[3 + 2 * n] = std::complex<_Float128>(-3.0, -3.0); a[3 + 3 * n] = std::complex<_Float128>(0.0, 4.0); 
