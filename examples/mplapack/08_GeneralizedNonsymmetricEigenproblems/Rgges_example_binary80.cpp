...
bool select_none(mplapack_binary80_t ar, mplapack_binary80_t ai, mplapack_binary80_t beta) {
    return false;
}
int main() {
    ...
    mplapack_binary80_t *vsl = new mplapack_binary80_t[1];
    mplapack_binary80_t *vsr = new mplapack_binary80_t[1];
