...
void getAinv(mplapackint n, mplapackint lda, dd_real * A)
{
    mplapackint info;
    mplapackint lwork;
...
dd_real get_estimated_condition_num(const char *norm, mplapackint n, mplapackint lda, dd_real * A)
{
    dd_real anorm, cond, rcond;
    dd_real *work = new dd_real[std::max((mplapackint) 1, n * 4)];
...
dd_real get_exact_condition_num(const char *norm, mplapackint n, mplapackint lda, dd_real * A)
{
    dd_real *Ainv = new dd_real[n * n];
    dd_real *work = new dd_real[std::max((mplapackint) 1, n)];
