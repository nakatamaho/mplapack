...
int main() {
    ...
    mplapack_binary80_t theta = mplapack_binary80_t(0.1), c = cos(theta), s = sin(theta);
    mplapack_binary80_t *a = new mplapack_binary80_t[m * n];
    mplapack_binary80_t *asvd = new mplapack_binary80_t[m * n];
    ...
    mplapack_binary80_t *sigma = new mplapack_binary80_t[n];
    ...
    mplapack_binary80_t *tau = new mplapack_binary80_t[n];
