...
int main() {
    ...
    dd_real *a = new dd_real[lda * m];
    dd_real *b = new dd_real[ldb * p];
    dd_real *d = new dd_real[n];
    dd_real *x = new dd_real[m];
    dd_real *y = new dd_real[p];
    dd_real *xexact = new dd_real[m];
    dd_real *yexact = new dd_real[p];
    ...
    xexact[0] = 1;
    xexact[1] = 2;
    yexact[0] = dd_real(0.5);
    yexact[1] = dd_real(-0.5);
    yexact[2] = 1;
    for (mplapackint i = 0; i < n; i++)
