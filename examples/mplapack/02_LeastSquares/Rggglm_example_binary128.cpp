...
int main() {
    ...
    mplapack_binary128_t *a = new mplapack_binary128_t[lda * m];
    mplapack_binary128_t *b = new mplapack_binary128_t[ldb * p];
    mplapack_binary128_t *d = new mplapack_binary128_t[n];
    mplapack_binary128_t *x = new mplapack_binary128_t[m];
    mplapack_binary128_t *y = new mplapack_binary128_t[p];
    mplapack_binary128_t *xexact = new mplapack_binary128_t[m];
    mplapack_binary128_t *yexact = new mplapack_binary128_t[p];
    ...
    xexact[0] = 1.0;
    xexact[1] = 2.0;
    yexact[0] = mplapack_binary128_t(0.5);
    yexact[1] = mplapack_binary128_t(-0.5);
    yexact[2] = 1.0;
    for (mplapackint i = 0; i < n; i++)
