...
int main() {
    ...
    Rgelsy(m, n, nrhs, a, lda, b, ldb, jpvt, mplapack_binary80_t(-1.0), rank, &wk, lwork, info);
    lwork = castINTEGER_binary80(wk);
    mplapack_binary80_t *work = new mplapack_binary80_t[lwork];
    Rgelsy(m, n, nrhs, a, lda, b, ldb, jpvt, mplapack_binary80_t(-1.0), rank, work, lwork, info);
