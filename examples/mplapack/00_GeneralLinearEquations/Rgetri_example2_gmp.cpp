...
//DOI: 10.1588/nolta.2.226
    a[0 + 0 * n] = 17.0;   a[0 + 1 * n] = -864.0; a[0 + 2 * n] = 716.0;    a[0 + 3 * n] = -799.0;
    a[1 + 0 * n] = 1.0;    a[1 + 1 * n] = -50.0;  a[1 + 2 * n] = 0.0;    a[1 + 3 * n] = 0.0;
    a[2 + 0 * n] = 0.0;  a[2 + 1 * n] = 1.0;    a[2 + 2 * n] = -50.0;    a[2 + 3 * n] = 0.0;
    a[3 + 0 * n] = 0.0;  a[3 + 1 * n] = 0.0;  a[3 + 2 * n] = 1.0;      a[3 + 3 * n] = -50.0;
