...
mpf_class inf_norm(mplapackint n, mpf_class *a, mplapackint lda) {
    mpf_class anorm = 0.0;
    for (mplapackint i = 0; i < n; i++) {
        mpf_class s = 0.0;
        for (mplapackint j = 0; j < n; j++)
...
int main() {
    ...
    printf("true cond_1 = "); printnum(mpf_class(1.0e6)); printf("\n");
