...
int main() {
    ...
    mplapack_binary80_t *af = new mplapack_binary80_t[n * n];
    ...
    mplapack_binary80_t *r = new mplapack_binary80_t[n];
    mplapack_binary80_t *c = new mplapack_binary80_t[n];
    mplapack_binary80_t *ferr = new mplapack_binary80_t[nrhs];
    mplapack_binary80_t *berr = new mplapack_binary80_t[nrhs];
    mplapack_binary80_t *work = new mplapack_binary80_t[4 * n];
