...
int main() {
    ...
    a[0 + 0 * lda] = std::complex<mplapack_binary128_t>(3.0, 0.0);  a[0 + 1 * lda] = std::complex<mplapack_binary128_t>(1.0, -1.0);
    a[1 + 0 * lda] = std::complex<mplapack_binary128_t>(1.0, 1.0);  a[1 + 1 * lda] = std::complex<mplapack_binary128_t>(4.0, 0.0);
    xexact[0] = std::complex<mplapack_binary128_t>(1.0, 2.0);
    xexact[1] = std::complex<mplapack_binary128_t>(-1.0, 1.0);
