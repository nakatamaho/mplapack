...
int main() {
    ...
    a[0 + 0 * lda] = mpcomplex(3.0, 0.0);  a[0 + 1 * lda] = mpcomplex(1.0, -1.0);
    a[1 + 0 * lda] = mpcomplex(1.0, 1.0);  a[1 + 1 * lda] = mpcomplex(4.0, 0.0);
    xexact[0] = mpcomplex(1.0, 2.0);
    xexact[1] = mpcomplex(-1.0, 1.0);
