...
int main() {
    ...
    dd_complex *b = new dd_complex[nrhs * ldb];
    dd_complex *borg = new dd_complex[nrhs * ldb];
    dd_complex *xexact = new dd_complex[nrhs * n];
    mplapackint *ipiv = new mplapackint[n];

    a[0 + 0 * lda] = dd_complex(2.0, 0.0); a[0 + 1 * lda] = dd_complex(1.0, 1.0);
    a[1 + 0 * lda] = dd_complex(1.0, -1.0); a[1 + 1 * lda] = dd_complex(3.0, 0.0);
    xexact[0] = dd_complex(1.0, 0.0); xexact[1] = dd_complex(0.0, 1.0);
    xexact[0 + 1 * n] = dd_complex(-1.0, 2.0); xexact[1 + 1 * n] = dd_complex(2.0, -1.0);
