...
int main() {
    ...
    a[0 + 0 * lda] = mpc_class(3.0, 0.0);  a[0 + 1 * lda] = mpc_class(1.0, -1.0);
    a[1 + 0 * lda] = mpc_class(1.0, 1.0);  a[1 + 1 * lda] = mpc_class(4.0, 0.0);
    xexact[0] = mpc_class(1.0, 2.0);
    xexact[1] = mpc_class(-1.0, 1.0);
