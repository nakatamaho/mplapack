...
int main() {
    ...
    a[0 + 0 * lda] = mpfc_class(3.0, 0.0);  a[0 + 1 * lda] = mpfc_class(1.0, -1.0);
    a[1 + 0 * lda] = mpfc_class(1.0, 1.0);  a[1 + 1 * lda] = mpfc_class(4.0, 0.0);
    xexact[0] = mpfc_class(1.0, 2.0);
    xexact[1] = mpfc_class(-1.0, 1.0);
