...
int main() {
    ...
    a[0 + 0 * lda] = qd_complex(3.0, 0.0);  a[0 + 1 * lda] = qd_complex(1.0, -1.0);
    a[1 + 0 * lda] = qd_complex(1.0, 1.0);  a[1 + 1 * lda] = qd_complex(4.0, 0.0);
    xexact[0] = qd_complex(1.0, 2.0);
    xexact[1] = qd_complex(-1.0, 1.0);
