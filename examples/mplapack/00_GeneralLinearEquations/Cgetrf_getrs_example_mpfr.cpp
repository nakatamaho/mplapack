...
int main() {
    ...
    mpcomplex *b = new mpcomplex[nrhs * ldb];
    mpcomplex *borg = new mpcomplex[nrhs * ldb];
    mpcomplex *xexact = new mpcomplex[nrhs * n];
    mplapackint *ipiv = new mplapackint[n];

    a[0 + 0 * lda] = mpcomplex(2.0, 0.0); a[0 + 1 * lda] = mpcomplex(1.0, 1.0);
    a[1 + 0 * lda] = mpcomplex(1.0, -1.0); a[1 + 1 * lda] = mpcomplex(3.0, 0.0);
    xexact[0] = mpcomplex(1.0, 0.0); xexact[1] = mpcomplex(0.0, 1.0);
    xexact[0 + 1 * n] = mpcomplex(-1.0, 2.0); xexact[1 + 1 * n] = mpcomplex(2.0, -1.0);
