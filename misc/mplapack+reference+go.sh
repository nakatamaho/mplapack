#!/bin/bash
#this script generates include/mplapack_benchmark_gmp.h, include/mplapack_benchmark_binary128.h
...
for p in gmp mpfr binary128 double dd qd
do
rm $p.h
for n in libmplapack_"$p"_ref*.o
do
