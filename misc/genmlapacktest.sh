...
sed -i.bak "s/___MPACK_BUILD_WITH_GMP___/___MPACK_BUILD_WITH_QD___/g" ../qd/Makefile.am
sed -i.bak "s/___MPACK_BUILD_WITH_GMP___/___MPACK_BUILD_WITH_DD___/g" ../dd/Makefile.am
