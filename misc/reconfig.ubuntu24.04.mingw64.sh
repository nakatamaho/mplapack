...
./configure --prefix=$HOME/MPLAPACK_MINGW --host=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --enable-gmp=yes --enable-mpfr=yes --enable-double=yes --enable-_Float128=yes --enable-qd=yes --enable-dd=yes --enable-test=yes --enable-benchmark=yes
