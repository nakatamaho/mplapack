  ...
  for tok in group_power(tokens=tokens):
    ...
    if (tok.is_seq()):
      ...
      if (cmn_needs_to_be_inserted(conv_info=conv_info, prev_tok=prev_tok)):
        ...
        if (prev_tok is not None and prev_tok.is_identifier() and prev_tok.value != "min" and prev_tok.value != "dsign" and prev_tok.value != "dsqrt" and prev_tok.value != "dble" and prev_tok.value != "dimag" and prev_tok.value != "max" and prev_tok.value != "abs"  and prev_tok.value != "sqrt" and prev_tok.value != "log2" and prev_tok.value != "pow2" and prev_tok.value != "dlamch" and prev_tok.value != "int" and prev_tok.value != "lsame" and prev_tok.value != "ddot" and prev_tok.value != "pow2" and prev_tok.value != "disnan" and prev_tok.value != "mod" and prev_tok.value != "dabs" and prev_tok.value != "cdabs" and prev_tok.value != "dconjg" and prev_tok.value != "dcabs1" and prev_tok.value != "dcmplx" and prev_tok.value != "ceiling" and prev_tok.value != "cos" and prev_tok.value != "sin" and prev_tok.value != "ilaenv"  and prev_tok.value != "disnan" and prev_tok.value != "dlaisnan" and prev_tok.value != "idamax" and prev_tok.value != "ladiv2" and prev_tok.value != "sign" and prev_tok.value != "iladlr" and prev_tok.value != "iladlc" and prev_tok.value != "stack" and prev_tok.value != "log" and prev_tok.value != "dnrm2" and prev_tok.value != "dlapy2" and prev_tok.value != "dlanst"  and prev_tok.value != "dlansy" ):
