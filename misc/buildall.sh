...
export CXX="icpc"
export FC="ifort"
./configure --enable-optimization=yes --enable-debug=yes --enable-mpfr=yes --enable-qd=yes --enable-double=yes --enable-__float128=yes --prefix=/home/maho/MPACK.ICC --with-external-blas="-mkl" --with-external-lapack="-mkl"
/usr/bin/time make -j20
/usr/bin/time make install
cd ..
cd ..
