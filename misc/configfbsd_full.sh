...
./configure --prefix=$HOME/mplapack-work-full/MPLAPACK --with-system-gmp=yes --with-system-mpfr=yes --with-system-mpc=yes --with-system-qd=yes --enable-debug=yes --enable-mpfr=yes --enable-qd=yes --enable-double=yes --enable-_Float128=yes
