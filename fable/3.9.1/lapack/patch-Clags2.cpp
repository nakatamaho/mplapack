diff --git a/mplapack/reference/Clags2.cpp b/mplapack/reference/Clags2.cpp
index 862988f3..00914102 100644
--- a/mplapack/reference/Clags2.cpp
+++ b/mplapack/reference/Clags2.cpp
@@ -113,16 +113,16 @@ void Clags2(bool const upper, REAL const a1, COMPLEX const a2, REAL const a3, RE
             vb11r = csr * b1;
...
+            } else if (aua12 / (abs(ua11r) + abs1(ua12)) <= avb12 / (abs(vb11r) + abs1(vb12))) {
                 ...
                 Clartg(-COMPLEX(vb11r), conj(vb12), csq, snq, r);
@@ -144,16 +144,16 @@ void Clags2(bool const upper, REAL const a1, COMPLEX const a2, REAL const a3, RE
             vb21 = -conj(d1) * snr * b1;
...
+            } else if (aua22 / (abs1(ua21) + abs1(ua22)) <= avb22 / (abs1(vb21) + abs1(vb22))) {
                 ...
                 Clartg(-conj(vb21), conj(vb22), csq, snq, r);
@@ -204,16 +204,16 @@ void Clags2(bool const upper, REAL const a1, COMPLEX const a2, REAL const a3, RE
...
+            } else if (aua21 / (abs1(ua21) + abs(ua22r)) <= avb21 / (abs1(vb21) + abs(vb22r))) {
                 ...
                 Clartg(COMPLEX(vb22r), vb21, csq, snq, r);
@@ -235,16 +235,16 @@ void Clags2(bool const upper, REAL const a1, COMPLEX const a2, REAL const a3, RE
