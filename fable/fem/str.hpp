...
template <int StrLen> struct str {
    ...
    template <int OtherStrLen> str(str<OtherStrLen> const &other) { utils::copy_with_blank_padding(other.elems, OtherStrLen, elems, StrLen); }
    ...
    template <int OtherStrLen> void operator=(str<OtherStrLen> const &rhs) { str_ref(*this) = str_cref(rhs); }
...
template <int StrLen> inline void str_ref::operator=(str<StrLen> const &rhs) { utils::copy_with_blank_padding(rhs.elems, StrLen, elems(), len()); }
