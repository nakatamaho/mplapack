...
inline file_positioning_chain io::backspace(int unit) { return file_positioning_chain("backspace", unit_ptr(unit, /*auto_open*/ true)); }
inline file_positioning_chain io::endfile(int unit) { return file_positioning_chain("endfile", unit_ptr(unit, /*auto_open*/ true)); }
inline file_positioning_chain io::rewind(int unit) { return file_positioning_chain("rewind", unit_ptr(unit, /*auto_open*/ true)); }
} // namespace fem
#endif // GUARD
