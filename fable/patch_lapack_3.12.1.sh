...
patch -p3 < "${PATCH_DIR}/patch-Cgeev.cpp"
patch -p3 < "${PATCH_DIR}/patch-Cgesvj.cpp"
patch -p3 < "${PATCH_DIR}/patch-Cgges.cpp"
...
patch -p3 < "${PATCH_DIR}/patch-Cbdsqr.cpp"
patch -p3 < "${PATCH_DIR}/patch-Chgeqz.cpp"
patch -p3 < "${PATCH_DIR}/patch-Claqz2.cpp"
...
patch -p3 < "${PATCH_DIR}/patch-Rbdsqr.cpp"
patch -p3 < "${PATCH_DIR}/patch-Rhgeqz.cpp"
patch -p3 < "${PATCH_DIR}/patch-Rlaqz3.cpp"
