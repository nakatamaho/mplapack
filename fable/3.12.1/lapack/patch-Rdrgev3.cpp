...
+++ Rdrgev3.cpp	2026-04-16 00:00:00.000000000 +0900
@@ -436,7 +436,14 @@ void Rdrgev3(INTEGER const nsizes, INTEG
             }
             //
             for (j = 1; j <= n; j = j + 1) {
...
@@ -455,7 +461,14 @@ void Rdrgev3(INTEGER const nsizes, INTEG
             }
             //
             for (j = 1; j <= n; j = j + 1) {
+#if defined MPLAPACK_BUILD_WITH_MPFR || defined MPLAPACK_BUILD_WITH_GMP
...
@@ -482,7 +494,14 @@ void Rdrgev3(INTEGER const nsizes, INTEG
             }
             //
             for (j = 1; j <= n; j = j + 1) {
+#if defined MPLAPACK_BUILD_WITH_MPFR || defined MPLAPACK_BUILD_WITH_GMP
