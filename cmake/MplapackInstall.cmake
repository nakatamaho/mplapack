...
foreach(_target IN LISTS MPLAPACK_INSTALL_TARGETS)
  ...
  elseif(_target STREQUAL "mplapack_gmp" OR
    ...
    if(GMP_PKGCONFIG_FOUND)
      ...
      set(PC_REQUIRES "")
      set(PC_CFLAGS_EXTRA "-I${GMP_INCLUDE_DIR}")
  ...
  elseif(_target STREQUAL "mplapack_qd" OR
    ...
    if(QD_PKGCONFIG_FOUND)
      ...
      set(PC_REQUIRES "")
      set(PC_CFLAGS_EXTRA "-I${QD_INCLUDE_DIR}")
      get_filename_component(_qd_pc_libdir "${QD_LIBRARY}" DIRECTORY)
      set(PC_LIBS_EXTRA "-L${_qd_pc_libdir} -lqd")
      if(UNIX)
