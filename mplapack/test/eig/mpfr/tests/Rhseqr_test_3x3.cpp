...
int main() {
    ...
    mplapackint info;
    // setting A matrix
    t[0 + 0 * n] = 2.0e-6;    t[0 + 1 * n] = 1.0;    t[0 + 2 * n] = -2.0;
    t[1 + 0 * n] = 1.0e-6;    t[1 + 1 * n] = -2.0;   t[1 + 2 * n] = 4.0;
    t[2 + 0 * n] = 0.0;       t[2 + 1 * n] = 1.0;    t[2 + 2 * n] = -2.0;

    q[0 + 0 * n] = 1.0;       q[0 + 1 * n] = 0.0;    q[0 + 2 * n] = 0.0;
    q[1 + 0 * n] = 0.0;       q[1 + 1 * n] = 1.0;    q[1 + 2 * n] = 0.0;
    q[2 + 0 * n] = 0.0;       q[2 + 1 * n] = 0.0;    q[2 + 2 * n] = 1.0;
    {
